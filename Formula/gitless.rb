...
__END__
diff --git a/gitless/core.py b/gitless/core.py
index a6a1780..0251f1e 100644
--- a/gitless/core.py
+++ b/gitless/core.py
...
diff --git a/gitless/tests/test_e2e.py b/gitless/tests/test_e2e.py
index c478143..043a184 100755
--- a/gitless/tests/test_e2e.py
+++ b/gitless/tests/test_e2e.py
@@ -736,7 +736,7 @@ class TestPerformance(TestEndToEnd):
     # do the same for git
     t = time.time()
     git.branch('gitdev')
-    git.stash.save('--all')
